...
def directories_to_remove_on_clean(distro_directory):
    """Directories to remove if cleaning distro_directory."""
    return [
...
def directories_to_create_on_clean(distro_directory):
    """Directories to create if cleaning distro_directory."""
    return [
...
class LinuxContainer(container.AbstractContainer):
    ...
    def clean(self):
        ...
        for directory in directories_to_create_on_clean(self._distro_dir):
            try:
